...
class CommentaireController extends AbstractController
{
    ...
    public function addCommentaire(Request $request, PostGroup $postGroup, Security $security): Response
    {
    ...
    #[Route('/postgroup/{id}/commentaire/delete/{commentId}', name: 'commentaire_delete')]
    public function deleteCommentaire($commentId, PostcommentaireRepository $pcRepository, ManagerRegistry $managerRegistry): Response
    {
    ...
    #[Route('/postgroup/{id}/commentaire/edit/{commentId}', name: 'commentaire_edit')]
    public function editpostgroup($commentId, PostcommentaireRepository $pcRepository, Request $request, ManagerRegistry $managerRegistry): Response
    {
        $em = $managerRegistry->getManager();
